vim.pack.add({
  ...
  -- required for the 99.extensions.telescope model/provider picker below
...
_99.setup({
  ...
  -- default model "opencode/claude-sonnet-4-5" isn't valid for a github-copilot
  -- provider setup, so pin it to a model that actually exists (see `opencode models`)
